package com.cwj.yudada.service.impl;
...
import com.cwj.yudada.constant.CommonConstant;
import com.cwj.yudada.exception.ThrowUtils;
import com.cwj.yudada.mapper.UserAnswerMapper;
...
import com.cwj.yudada.utils.SqlUtils;
...
public class UserAnswerServiceImpl extends ServiceImpl<UserAnswerMapper, UserAnswer> implements UserAnswerService {
    ...
    public void validUserAnswer(UserAnswer userAnswer, boolean add) {
        ...
        if (add) {
            // 补充校验规则
            ThrowUtils.throwIf(appId==null||appId<=0, ErrorCode.PARAMS_ERROR,"用户ID非法");
        }
        // 修改数据时，有参数则校验
       if(appId!=null){
           appService.getById(appId);
           ThrowUtils.throwIf(appService.getById(appId)==null, ErrorCode.PARAMS_ERROR,"应用不存在");
       }
    }
    ...
    public QueryWrapper<UserAnswer> getQueryWrapper(UserAnswerQueryRequest userAnswerQueryRequest) {
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(userId), "resultId", resultId);
